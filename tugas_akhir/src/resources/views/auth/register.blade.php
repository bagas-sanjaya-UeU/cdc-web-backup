            ...
            <div class="max-w-4xl mx-auto bg-white rounded-2xl shadow-2xl overflow-hidden grid md:grid-cols-2">
                ...
                <div class="hidden md:block bg-cover bg-center"
                    ...
                    <div class="p-8 text-white bg-black bg-opacity-50 h-full flex flex-col justify-end">
                        <h2 class="text-3xl font-extrabold mb-2">Buat Akun Baru</h2>
                        <p class="text-gray-200">Daftar sekarang untuk mulai memesan tempat dan menikmati berbagai fitur
                            eksklusif kami.</p>
                    </div>
                </div>
                ...
                <div class="p-8 md:p-12">
                    ...
                    <h3 class="text-2xl font-bold text-gray-800 mb-2">{{ __('Register') }}</h3>
                    ...
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="mb-5">
                            <label for="name"
                                class="block mb-2 text-sm font-medium text-gray-700">{{ __('Nama') }}</label>
                            <input id="name" type="text"
                                class="w-full px-4 py-3 bg-gray-50 border @error('name') border-red-500 @else border-gray-300 @enderror rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"
                        ...
                        <div class="mb-6">
                            <label for="password-confirm"
                                class="block mb-2 text-sm font-medium text-gray-700">{{ __('Konfirmasi Password') }}</label>
